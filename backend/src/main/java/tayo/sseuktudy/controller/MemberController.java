...
public class MemberController {
    ...
    public ResponseEntity<Map<String, Object>> getPreApplyInfo(@RequestParam int studyId, HttpServletRequest request){
        logger.info("스터디 신청 전 정보 가져오기 API");
        Map<String, Object> resultMap  = new HashMap<>();
        HttpStatus status = HttpStatus.UNAUTHORIZED;
        String decodeUserId = jwtService.decodeToken(request.getHeader("access-token"));
        ...
        if(!decodeUserId.equals("access token timeout")){
            ...
            try{
                ...
                List<QuestionInfoDto> result = memberService.getQuestionInfo(studyId);
